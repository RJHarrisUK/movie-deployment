...
multi("GET", "http://34.65.182.174:8888/movieapp/api/movie/getAllMovies").then(val => {
...
const deleteButtonHandler = () => {
    ...
    multi("DELETE", "http://34.65.182.174:8888/movieapp/api/movie/deleteMovie/" + event.target.id).then(val => {
